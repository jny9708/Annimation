                  ...
                  <div class="col-sm-12"><!--지원카드 시작-->
                      ...
                      <div id="dede">
                          <div id="card_User">
                            ...
                            <%}else{
                            	System.out.println("아이콘경로있음");%>
                				<img src="<%=request.getContextPath()%>/image/<%=app_parent_list.get(i).getMem_icon()%>" alt="User-img" class="projact_card_U img-circle" data-toggle="tooltip" title="<%=app_parent_list.get(i).getMem_nickname()%> 페이지 보기" data-original-title="Default tooltip">
                            <% } %>
